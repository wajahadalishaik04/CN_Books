...
const VerifyScreen = () => {
  ...
  const location = useLocation(); // Get the state passed from the SignUp page
  const { emailMobile } = location.state || {}; // Default to an empty object if no state is passed
      ...
      >
        <Box flex={1} p={6} mt={1}>
          <Box flex={1} width={"330px"}>
            ...
            <Typography>Enter the OTP sent to your mobile number or email.</Typography>
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Typography variant="span">
                {emailMobile} {/* Display email or mobile number */}
              </Typography>
