...
const SignUp = () => {
  ...
  // States to manage email, password, and validation
  ...
  // Submit handler
  const handleSubmit = () => {
    // Check if the email or mobile number is valid and password is provided
    if (!emailMobile) {
      ...
      >
        ...
        <Box flex={1} p={6} mt={1}>
          ...
          <Box width={"330px"} flex={1} component={"form"}>
            ...
            {errorMessage && (
              <Typography color="error" backgroundColor="none" variant="body2" mt={1.5}>
                {errorMessage}
              </Typography>
            )}
