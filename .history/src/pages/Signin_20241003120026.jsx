...
const Signin = () => {
  ...
  const [isValid, setIsValid] = useState(false); // To track if input is valid
  ...
  const validateInput = (value) => {
    ...
    // Check if the input is either a valid email or a 10-digit mobile number
              ...
              sx={{
                "& .MuiOutlinedInput-root": {
                  ...
                  "&.Mui-focused": {
                    ...
                    borderColor: isValid ? "#5BC4FA" : "red", // Dynamic border color
                  },
                  borderColor: isValid ? "#5BC4FA" : "red", // Border color based on validation
                },
              }}
            />
