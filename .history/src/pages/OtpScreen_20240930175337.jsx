...
const OtpScreen = () => {
  ...
  const [successSnackbarOpen, setSuccessSnackbarOpen] = useState(false); // Success message control
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img src={images.otpImg} alt="Illustration" width="100%" height="100%" objectFit />
        </Box>
      </Box>
    </Box>
  );
