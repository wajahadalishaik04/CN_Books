...
import { Check, CheckCircle, Info as InfoIcon } from "@mui/icons-material";
                    ...
                    <Tooltip
                      ...
                      title={
                        <ul style={{listStyleType:"none"}} >
                          <li style={{ color: passwordValidations.length ? <CheckCircle color="blue"/> : <CheckCircle color="red"/> }}>
                            8-16 characters
                          </li>
