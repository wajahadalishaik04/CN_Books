...
const SignUp = () => {
  ...
  sx={{
    ...
    "& .MuiFormHelperText-root": {
      marginLeft: 0,
      fontSize: "0.8rem", // Make the font smaller to look subtle
      color: "red", // Ensures the error message is in red
    },
  }}
/>
...
<TextField
  ...
  helperText={
    passwordError && formSubmitted ? "Please enter a valid password" : ""
  }
  InputProps={{
    endAdornment: (
