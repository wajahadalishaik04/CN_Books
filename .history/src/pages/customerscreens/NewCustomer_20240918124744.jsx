      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        {tabsValue === 1 && (
          <Box sx={{ padding: 3 }}>
            ...
            {/* Note Section */}
            <Box sx={{paddingTop:3,display:"flex", flexDirection:"column",paddingLeft:1.5,paddingBottom:5}}>
              <Box display={"flex"}>
              <Typography   borderLeft={"3px solid #5BC4FA"}marginRight={0.5}fontWeight={500} />
              <Typography  variant="subtitle1"fontSize={"1.1rem"}fontWeight={500}>Note:</Typography>   
              </Box>
