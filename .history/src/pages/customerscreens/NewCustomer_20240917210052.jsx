      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        {tabsValue === 0 && (
          <Box sx={{ padding: 2 }}>
            ...
            <Box sx={{ display: "flex", gap: 6.5, mt: 1, alignItems: "center" }}>
            ...
            >
              ...
              <Box  display={"flex"}flexDirection={"column"}>
                <Button
                sx={{ width:180,backgroundColor:"#F3F3F3",color:'#939393'}}
                  component="label"
                  role={undefined}
                  variant="contained"
                  tabIndex={-1}
                ...
                <Typography variant="caption" color="#939393">You can upload the maximum of 3 files, 10MB each</Typography>
              </Box>
            </Box>
            ...
            >
              <Typography variant="subtitle1">Documents</Typography>
              <Box width={558}>
                <StyledTextField placeholder="Website Url"type="url" fullWidth size="small" />
              </Box>
            </Box>
          </Box>
        )}
