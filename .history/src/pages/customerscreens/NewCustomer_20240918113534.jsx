      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        {tabsValue === 1 && (
          <Box sx={{ padding: 3 }}>
            ...
            {/* Note Section */}
            <Box sx={{paddingTop:3,display:"flex", flexDirection={"colu"}}}>
              ...
              <Typography variant="body1" component={List}>View and edit the address format of your transactions under Settings > Preferences > Customers.</Typography>
            </Box>
          </Box>
        )}
        {tabsValue === 2 && (
