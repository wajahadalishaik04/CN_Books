       ...
       {addmore &&(<>
        ...
        {tabsValue === 0 && (
          <Box sx={{ padding: 2 }}>
            ...
            {/* Upload Documents */}
            <Box sx={{ display: "flex", mt: 2,mb:1.5, alignItems: "center", gap: 11, fontWeight: 400 }}>
      ...
      <Box display={"flex"} flexDirection={"column"}>
        ...
        {tabsValue === 1 && (
              ...
              <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                <Typography variant="subtitle1" fontSize={"1.2rem"}>Billing Address</Typography>
                <Box sx={{ display: "flex", paddingRight: 12.3, gap: 1.5 }}>
                  <Typography variant="subtitle1" fontSize={"1.2rem"}>Shipping Address</Typography>
                  <Button variant="text" sx={{textTransform:"none"}} onClick={copyBillingToShipping}>
                    (<img src={images.dollararrowicon} alt="" /> Copy Billing Address)
                  </Button>
                </Box>
              </Box>
              ...
              <Box display={"flex"} justifyContent={"space-between"} mt={2}>
                <Box display={"flex"} gap={11} alignItems={"center"}>
                  ...
                  type="text"
                    ...
                    onChange={(e) => handleBillingAddressChange('attention', e.target.value)}
                  />
                </Box>
                <Box display={"flex"} gap={12.6} paddingRight={8} alignItems={"center"}>
                  <Typography variant="subtitle1">Attention</Typography>
                  <StyledTextField
                    size="small"
                    value={shippingAddress.attention}
                    onChange={(e) => handleShippingAddressChange('attention', e.target.value)}
                  />
                </Box>
              </Box>
              ...
              <Box display={"flex"} justifyContent={"space-between"} mt={1.5}>
                <Box display={"flex"} gap={5} alignItems={"center"}>
                  ...
                  <Autocomplete
                    ...
                    onChange={(e, newValue) => handleBillingAddressChange('countryRegion', newValue)}
                    renderInput={(params) => (
                      <StyledTextField {...params} size="small" sx={{ width: 210 }} placeholder="Select" />
                    )}
                  />
                </Box>
                <Box display={"flex"} gap={7} paddingRight={8} alignItems={"center"}>
                  <Typography variant="subtitle1">Country/Region</Typography>
                  <Autocomplete
                    size="small"
                    {...countryRegionName}
                    ...
                    onChange={(e, newValue) => handleShippingAddressChange('countryRegion', newValue)}
                    renderInput={(params) => (
                      <StyledTextField {...params} size="small" sx={{ width: 210 }} placeholder="Select" />
                    )}
                  />
              ...
              {/* Address Input Field */}
              <Box display={"flex"} justifyContent={"space-between"} mt={1.5}>
                <Box display={display:"flex",flexDirection:"column"} gap={11.5} alignItems={"center"}>
                ...
                <Box display={"flex"} gap={13.7} paddingRight={8} alignItems={"center"}>
                  <Typography variant="subtitle1">Address</Typography>
                  <StyledTextField
                    multiline
                    placeholder="Street1"
              ...
              <Box display={"flex"} justifyContent={"space-between"} mt={2}>
                ...
                <Box display={"flex"} gap={18} paddingRight={8} alignItems={"center"}>
                  <Typography variant="subtitle1">City</Typography>
                  <StyledTextField
                    type="text"
                    size="small"
              ...
              <Box display={"flex"} justifyContent={"space-between"} mt={1.5}>
                <Box display={"flex"} gap={14} alignItems={"center"}>
                  ...
                  <Autocomplete
                    ...
                    onChange={(e, newValue) => handleBillingAddressChange('state', newValue)}
                    renderInput={(params) => (
                      <StyledTextField {...params} size="small" sx={{ width: 210 }} placeholder="Select State" />
                    )}
                  />
                </Box>
                <Box display={"flex"} gap={17} paddingRight={8} alignItems={"center"}>
                  <Typography variant="subtitle1">State</Typography>
                  <Autocomplete
                    size="small"
                    {...stateName}
                    ...
                    onChange={(e, newValue) => handleShippingAddressChange('state', newValue)}
                    renderInput={(params) => (
                      <StyledTextField {...params} size="small" sx={{ width: 210 }} placeholder="Select State" />
                    )}
                  />
              ...
              <Box display={"flex"} justifyContent={"space-between"} mt={2}>
                ...
                <Box display={"flex"} gap={13.6} paddingRight={8} alignItems={"center"}>
                  <Typography variant="subtitle1">Pin Code</Typography>
                  <StyledTextField
                    type="number"
                    size="small"
              ...
              <Box display={"flex"} justifyContent={"space-between"} mt={2}>
                ...
                <Box display={"flex"} gap={16.3} paddingRight={8} alignItems={"center"}>
                  <Typography variant="subtitle1">Phone</Typography>
                  <StyledTextField
                    type="number"
                    size="small"
              ...
              <Box display={"flex"} justifyContent={"space-between"} mt={2}>
                <Box display={"flex"} gap={7.7} alignItems={"center"}>
                  ...
                  <StyledTextField
                    ...
                    onChange={(e) => handleBillingAddressChange('faxNumber', e.target.value)}
                  />
                </Box>
                <Box display={"flex"} gap={11.4} paddingRight={8} alignItems={"center"}>
                  <Typography variant="subtitle1">Fax Number</Typography>
                  <StyledTextField
                    type="number"
                    size="small"
                    value={shippingAddress.faxNumber}
                    onChange={(e) => handleShippingAddressChange('faxNumber', e.target.value)}
                  />
                </Box>
              </Box>
        
              {/* Note Section */}
              <Box sx={{ marginTop: 4, display: "flex", flexDirection: "column", paddingLeft: "0.8px", marginBottom: 3 }}>
                <Box display={"flex"}>
                  <Typography borderLeft={"3px solid #5BC4FA"} marginRight={0.5} fontWeight={500} />
                  <Typography variant="subtitle1" component={"span"} fontSize={"1.1rem"} fontWeight={500}>Note:</Typography>
                </Box>
                <Box display={"flex"} alignItems="center" paddingLeft={1}>
                  <Box sx={{ width: "8px", height: "8px", backgroundColor: "black", borderRadius: "50%", marginRight: 1 }}></Box>
                  <Typography variant="body2">
                    View and edit the address format of your transactions under Settings &gt; Preferences &gt; Customers.
                  </Typography>
                </Box>
              </Box>
            </Box>
          ...
          >
            ...
            <Box marginBottom={2} marginTop={3}>
              <Typography
                variant="subtitle1"
                component={Button}
                sx={{ color: "#5BC4FA", fontSize: "0.95rem", textTransform:"none" }}
              >
                + Add Contact Person
              </Typography>
            </Box>
        ...
        {/* footerButtons */}
        <Box sx={{ display: "flex", p: 2, boxShadow: "1px 0px 2.5px #00000040" }}>
          <Button
            variant="contained"
            sx={{ marginRight: 2, backgroundColor: "#5BC4FA",textTransform:"none" }}
          >
            Save
          </Button>
          <Button
