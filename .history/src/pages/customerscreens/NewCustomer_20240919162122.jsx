...
// addMore button
  ...
  return (
    <Box sx={{ display: "flex", height: "100vh" }}>
      <Box sx={{ flexGrow: 1 }}>
        <Box padding={3}>
         <Typography variant="h6"  component={"span"} sx={{fontSize:"1.5rem",}}>New Customer</Typography> 
          {/* Customer Type */}
          ...
          <StyledButton variant="text">+ AddMore</StyledButton>
        </Box>
        {/* Tab Section */}
        <Tabs
          sx={{ borderBottom: "3px solid #EFEFEF" }}
          value={tabsValue,  const [addmore,setAddMore] = useState("")
}
        ...
        {tabsValue === 2 && (
          ...
          // contact Person table
          <Box display="flex"  flexDirection={"column"} padding={3}paddingTop={5}  >
  <TableContainer
    component={Paper}
    sx={{ maxHeight: { xs: '400px', md: 'auto' }, overflowY: 'auto',overflowX:"hidden" }}
  >
    <Table > 
  ...
  <Typography variant="subtitle1" component={Button} sx={{color:"#5BC4FA",fontSize:"0.95rem"}}>+ Add Contact Person</Typography>
        ...
        <Box sx={{ display: "flex", p: 2, boxShadow: "0 -1px 2px #00000040" }}>
          <Button variant="contained" sx={{ marginRight: 2, backgroundColor:"#5BC4FA" }}>
            Save
          </Button>
          <Button variant="outlined" sx={{backgroundColor:"#F3F3F3",color:"black",borderColor:"#A7A7A7"}}>Cancel</Button>
        </Box>
      </Box>
    </Box>
  );
