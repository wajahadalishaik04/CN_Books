  ...
  {tabsValue === 0 && (
          <Box sx={{ padding: 2 }}>
            ...
            <FormControl fullWidth margin="normal">
              <Select placeholder="Gst Statement">
                <MenuItem value={10}>GST Treatment 1</MenuItem>
                <MenuItem value={20}>GST Treatment 2</MenuItem>
                <MenuItem value={30}>GST Treatment 2</MenuItem>
              </Select>
            </FormControl>
