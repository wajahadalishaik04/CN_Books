...
const NewCustomer = () => {
  ...
  const tableData = (salutation,firstName,lastName,emailAddress,	workPhone,mobilePhone,designation,department) =>{
    return {salutation,firstName,lastName,emailAddress,	workPhone,mobilePhone,designation,department};
  }
const rows = [
  tableData("Mr","Rahul","K.","rahul@gmail.com",477437647,876487878,"business","sales"),
  tableData("Mr","Rahul","K.","rahul@gmail.com",477437647,876487878,"business","sales"),
  tableData("Mr","Rahul","K.","rahul@gmail.com",477437647,876487878,"business","sales"),
  tableData("Mr","Rahul","K.","rahul@gmail.com",477437647,876487878,"business","sales"),
  ...
  return (
    <Box sx={{ display: "flex", height: "100vh" }}>
      <Box sx={{ flexGrow: 1 }}>
        ...
        {tabsValue === 2 && (
          // contact Person table
          <Box display="flex" padding={3} alignItems="center"width={"1060px"}  overflowX={"auto"}overflowY={"auto"}>
           <TableContainer component={Paper}>
            ...
            >
              ...
              <TableCell align="right">{row.workPhone}</TableCell>
              <TableCell align="right">{row.designation}</TableCell>
              <TableCell align="right">{row.desti}</TableCell>
            </TableRow>
          ))}
        </TableBody>
            </Table>
