      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        {tabsValue === 1 && (
          <Box sx={{ padding: 3 }}>
            ...
            {/* Note Section */}
            <Box sx={{paddingTop:4,display:"flex", flexDirection:"column",paddingLeft:1,paddingBottom:5}}>
              <Box display={"flex"}>
             ...
             <Box display={"flex" }alignItems="center"paddingLeft={1}>
              ...
              <Box sx={{width:"8px",height:"8px",backgroundColor:"black",borderRadius:"50%",marginRight:1}}></Box> {/* dot icon on css */}
              <Typography variant="body2" >View and edit the address format of your transactions under Settings &gt; Preferences &gt; Customers.</Typography>
