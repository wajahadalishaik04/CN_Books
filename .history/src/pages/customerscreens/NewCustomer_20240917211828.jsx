          ...
          <Box sx={{ padding: 2 }}>
            ...
            >
              ...
              <Box  sx={{display:"flex", alignItems:"center"}}>
                <Typography color="#939393"  variant="caption">Assign a user as the customer owner to provide access only to the data of this customer.<Box component={Link} sx={{color:"#5BC4FA",text}}>Learn more</Box></Typography>
              </Box>
            </Box>
          </Box>
        )}
