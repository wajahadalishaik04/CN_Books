import {  ArrowBackIos, ArrowForwardIos, CloudUpload } from "@mui/icons-material";
import {
  Box,
  Typography,
  Button,
...
const NewCustomer = () => {
  ...
  // State Inputfield
  const stateOpt = ["ANDHRAPRADESH", "TAMILNADU","SINGAPORE","DUBAI"];
  const stateName = {
    options: countryRegionOpt,
    getOptionLabel: (option) => option,
  };
      ...
      <Box sx={{ flexGrow: 1 }}>
          ...
          <Box sx={{ padding: 2 }}>
            ...
            >
              ...
              <Box  sx={{display:"flex", alignItems:"center"}}>
                <Typography color="#939393"  variant="caption">Assign a user as the customer owner to provide access only to the data of this customer.<Box component={Link} sx={{color:"#5BC4FA",textDecoration:"none"}}>Learn more</Box></Typography>
              </Box>
            </Box>
          </Box>
        )}
        {tabsValue === 1 && (
          <Box sx={{ padding: 3 }}>
           ...
           <Box component={Button} variant="text"> (<img src={images.dollararrowicon} alt="" />     Copy billing address) </Box>
        ...
        {tabsValue===2 && (
              ...
              {/* Table */}
              <TableContainer component={Paper} sx={{ overflowX: 'auto', whiteSpace: 'nowrap', width: 900 ,padding:5}} ref={tableRef}>
                <Table aria-label="contact table">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>Additional Column 1</TableCell> {/* Hidden initially */}
                      <TableCell>Additional Column 2</TableCell> {/* Hidden initially */}
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    <TableRow>
       ...
       {tabsValue===3 && (
        ...
        <Box display={"flex"} gap={1} alignItems={"center"} marginBottom={2}>
          ...
          <Typography variant="body2"component={"span"}color={"#939393"}>(For Internal Use)</Typography>
          </Box>
          <Box>
          <StyledTextField
              multiline
