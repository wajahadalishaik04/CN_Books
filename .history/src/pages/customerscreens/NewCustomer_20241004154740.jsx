...
const NewCustomer = () => {
  ...
  const [isBillingAttentionFocused, setIsBillingAttentionFocused] = useState(false);
              ...
              <Box sx={{ padding: 3 }}>
                ...
                <Box display={"flex"} justifyContent={"space-between"} mt={2}>
                  <Box display={"flex"} gap={11} alignItems={"center"}>
                    ...
                    <StyledTextField
  {...props}
  onFocus={() => setIsBillingAttentionFocused(true)}
  onBlur={() => setIsBillingAttentionFocused(false)}
  placeholder={!isBillingAttentionFocused && "Enter Attention"}
/>
