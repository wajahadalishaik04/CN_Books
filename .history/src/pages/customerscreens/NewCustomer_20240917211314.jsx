        ...
        {tabsValue === 0 && (
          <Box sx={{ padding: 2 }}>
            ...
            >
              ...
              <Box width={558}>
                <Typography  variant="caption">Assign a user as the customer owner to provide access only to the data of this customer.<Box component={L}>Learn more</Box></Typography>
              </Box>
            </Box>
          </Box>
        )}
