  ...
  return (
    <Box sx={{ display: "flex", height: "100vh" }}>
       ...
       {addmore &&(<>
        ...
        {tabsValue === 0 && (
          <Box sx={{ padding: 2 }}>
            ...
            {/* Upload Documents */}
            <Box sx={{ display: "flex", mt: 2, alignItems: "center", gap: 11, fontWeight: 400 }}>
      ...
      <Box display={"flex"} flexDirection={"column"}>
        ...
        <Typography variant="caption" color="#D32F2F">
          You can upload a maximum of 3 files, 10MB total.
        </Typography>
      </Box>
    </Box>
          ...
          <Box sx={{ padding: 3 }}>
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <Box sx={{ display: "flex", paddingRight: 12.3, gap: 1.5 }}>
                ...
                <Box component={Button} variant="text" textTransform={"none"}>
                  {" "}
