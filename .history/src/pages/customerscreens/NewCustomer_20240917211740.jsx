          ...
          <Box sx={{ padding: 2 }}>
            ...
            >
              ...
              <Box  sx={{display:"flex", alignItems:"center"}}>
                <Typography color="#93939"  variant="caption">Assign a user as the customer owner to provide access only to the data of this customer.<Box component={Link} sx={{color:"#939393"}}>Learn more</Box></Typography>
              </Box>
            </Box>
          </Box>
        )}
