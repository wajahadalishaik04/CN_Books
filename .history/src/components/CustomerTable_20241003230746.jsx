                ...
                <TableRow key={row.Name}>
                  ...
                  <TableCell align="center">
                    ...
                    <img
                      src={images.binicon}
                      alt="Bin Icon"
                      style={{ cursor: "pointer", width: "22px", height: "22px", marginRight: "10px",filter: "grayscale(100%), brightness(100%)" filter: "invert(22%) sepia(96%) saturate(3970%) hue-rotate(-6deg) brightness(91%) contrast(102%)" 
                      }}
