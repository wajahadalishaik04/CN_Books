...
const CustomerTable = () => {
  ...
  const [rows, setRows] = useState([
    ...
    createData("John", "john.smith@example.com", "1234523267890", "CoderNest", "Karnatka", "₹ 120.00"),
    createData("John Smith", "john.smith@example.com", "1234567890", "CodersNest", "Karnataka", "₹ 0.00"),
    createData("John Smith", "john.smith@example.com", "1234567890", "CodersNest", "Karnataka", "₹ 0.00"),
    createData("John Smith", "john.smith@example.com", "1234567890", "CodersNest", "Karnataka", "₹ 0.00"),
    createData("John Smith", "john.smith@example.com", "1234567890", "CodersNest", "Karnataka", "₹ 0.00"),
    ...
    <>
                ...
                <TableRow key={row.Name}>
                  ...
                  <TableCell align="center">
                    <img
                      src={images.editicon}
                      alt="Edit Icon"
                      style={{ cursor: "pointer", width: "22px", height: "22px", marginRight: "10px",filter: "grayscale(100%), brightness(120%)"  }}
                      onClick={() => handleEdit(row)}
                    />
                    <img
                      src={images.binicon}
                      alt="Bin Icon"
                      style={{ cursor: "pointer", width: "22px", height: "22px", marginRight: "10px",filter: "invert(22%) sepia(96%) saturate(3970%) hue-rotate(-6deg) brightness(91%) contrast(102%)"  }}
      ...
      <Snackbar
        ...
        message={
          <span >
            Row hidden!{" "}
            {undoAction && <span style={{ cursor: 'pointer', color: 'whitesmoke' }} onClick={handleUndo}>Undo</span>}
          </span>
        }
